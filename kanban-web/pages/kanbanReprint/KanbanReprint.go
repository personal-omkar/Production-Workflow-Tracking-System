...
func (k *KanbanReprintPage) Build() string {
	...
	kanbanreprint.CardHeading = "Kanban Reprint"
	kanbanreprint.CardHeadingActions.Component = append(kanbanreprint.CardHeadingActions.Component, s.CardHeadActionComponent{ComponentName: "button", ComponentType: s.ActionComponentElement{Button: s.ButtonAttributes{ID: "kanbanPrint", Name: "kanbanPrint", Type: "button", Text: "Kanban Print", Disabled: true}}, Width: "col-4"})
