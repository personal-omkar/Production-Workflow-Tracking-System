...
import (
	...
	kanbanreprint "irpl.com/kanban-web/pages/kanbanReprint"
)

func KanbanReprintPage(w http.ResponseWriter, r *http.Request) {
	...
	kanbanreprintpage := kanbanreprint.KanbanReprintPage{
		UserType: usertype,
		UserID:   userID,
	}
...
func PrintKanbanSummary(w http.ResponseWriter, r *http.Request) {
